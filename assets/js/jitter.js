document.addEventListener("DOMContentLoaded", () => {
  ...
  links.forEach(link => {
    ...
    link.addEventListener("mouseenter", () => {
      ...
      const jitterRotate = `${(Math.random() - 0.5) * 2}deg`;
      ...
      box.style.transformOrigin = "left center"; // added to prevent jump
      box.classList.add("wipe-in");
    });

    link.addEventListener("mouseleave", () => {
      box.classList.remove("wipe-in");
      box.style.transformOrigin = "right center"; // added to prevent jump
